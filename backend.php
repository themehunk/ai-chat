   ...
   <h2><?php _e('AI Chatboat (Open AI ChatGPT)','ai-chatboat'); ?></h2>
    ...
    <ul class="wrapper">
        <li class="form-row">
          ...
          <input type="text" id="open_api_key" name="open_api_key" value="<?php echo esc_html($api_key); ?>" class="regular-text"><br>
        </li>
        <li class="form-row">
...
function ai_chatboat_live_chat() {
 ...
 <div class="chat-popup" id="chatForm">
   <div class="form-container ">
     <div class="ai-header" onclick="openForm()"> <h2><img class="ai-head-img" id="user-0" src="<?php echo esc_url(AI_CHATBOT_URL); ?>images/bot-chat.png"><?php _e('Live AI Chatbot','ai-chatboat'); ?></h2></div>
