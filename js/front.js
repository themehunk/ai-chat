...
function ai_loader(){
    var loader = '<article class="msg-container msg-chat chat-auto-load" id="msg-chat"><div class="msg-box-chat"><div class="chat-loader"><div class="base-square"></div><div class="bubble"></div><div class="loading"><div class="dot dot--one"></div><div class="dot dot--two"></div><div class="dot dot--three"></div></div></div></div><audio controls autoplay audio style="display:none;"> <source src="'+ai_chatot_ajax.ai_chatbot_audio+'"  type="audio/mpeg"> </audio></article>';
